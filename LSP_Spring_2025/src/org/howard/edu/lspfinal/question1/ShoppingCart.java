...
public class ShoppingCart {
     ...
     * @throws throws IllegalArgumentException if price is negative
     */
    //Changed the code to meet the testing requirements
    public void addItem(String itemName, double price) {
        if (itemName == null || itemName.trim().isEmpty()) {
            throw new IllegalArgumentException("Item name cannot be empty.");
        }
        //Change this to <= to run the test case given in testing requirement
        if (price <= 0) {
     ...
     */
    // added to meet the testing requirement
